...
<div class="grid grid-cols-3 md:grid-cols-4 gap-4">
    ...
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
            <img class="p-8 rounded-t-lg" src="{{ asset('images/blogs_images/pic4.jpg')}}" alt="product image" />
        </a>
        <div class="px-5 pb-5">
            <a href="#">
                <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Bachelor In Information Technology</h5>
            </a>
            <div class="flex items-center mt-2.5 mb-5">
               Students enrolled
                <span class="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">55.0</span>
            </div>
