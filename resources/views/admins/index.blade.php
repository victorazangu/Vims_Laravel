...
@section('search-button')
    <div class="flex items-center justify-between pb-4 bg-white dark:bg-gray-900">
        ...
        <div class="relative">
            ...
            <input type="text" id="table-search-users" id='searchInput' onkeyup='searchTable()'
                    ...
                    <a href="{{ route('admin_show',$admin) }}">
                        <li class="flex justify-between gap-x-6 py-5">
                            <div class="flex gap-x-4">
                                <img class="h-12 w-12 flex-none rounded-full bg-gray-50" src="{{ $admin->profile }}"
                                    alt="">
                                <div class="min-w-0 flex-auto">
                                    <p class="text-sm font-semibold leading-6 text-gray-900">
                                        {{ Str::title($admin->firstName) }}
                                        {{ Str::title($admin->lastName) }}</p>
